...
| 2024-11-12 | DNS | Apex + subdomains pointing to legacy A records and circular CNAMES | Apex/web/www → `goldshore-web.pages.dev`, api → `goldshore-agent.goldshore.workers.dev` (proxied) | Legacy records purged; configuration now idempotent |
